...
%EVALUATE_7DOF_TRAJECTORY Re-evaluate forces and accelerations on a solution.
    ...
    tireExtrapolated = false(count, 4);
    ...
    for index = 1:count
        ...
        tireExtrapolated(index, :) = diagnostics.tire_extrapolated.';
    ...
    trace.tire_extrapolated = tireExtrapolated;
    trace.any_tire_extrapolated = any(tireExtrapolated, 2);
